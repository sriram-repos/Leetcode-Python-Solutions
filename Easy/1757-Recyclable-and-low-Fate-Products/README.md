...
Leetcode using MSQLSERVER
---------------------------
/* Write your T-SQL query statement below */
SELECT product_id FROM Products WHERE low_fats = 'Y' AND recyclable = 'Y'

Databaricks Workspace
--------------------------

The same logic is implemented in PySpark DataFrame using:

1. Create pySpark dataframe
   prod_sp_df = spark.createDataFrame(products)

2. Store result in Products dataframe
   prod_sp_df.createOrReplaceTempView('Products')
   
3. Use spark.SQL to write actual SQL filtering data
